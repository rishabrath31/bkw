...
const ACCESSORIES = [
  { id: 1, name: 'Riding Gloves Pro', brand: 'Rynox', price: '₹1,999', rating: 4.8, reviews: 143, image: 'https://images.unsplash.com/photo-1558981403-c5f9899a28bc?q=80&w=800&auto=format&fit=crop', badge: 'Popular', category: 'Gloves' },
  { id: 2, name: 'Knee Guard Set', brand: 'Cramster', price: '₹2,499', rating: 4.7, reviews: 76, image: 'https://images.unsplash.com/photo-1618151313441-bc79c11e50e0?q=80&w=800&auto=format&fit=crop', category: 'Protection' },
  { id: 3, name: 'Waterproof Riding Boots', brand: 'Axor', price: '₹5,800', originalPrice: '₹6,999', rating: 4.9, reviews: 201, image: 'https://images.unsplash.com/photo-1591047139829-d91aecb6caea?q=80&w=800&auto=format&fit=crop', badge: 'Bestseller', category: 'Boots' },
  { id: 4, name: 'Tank Bag Rucksack', brand: 'BKW', price: '₹1,499', rating: 4.5, reviews: 88, image: 'https://images.unsplash.com/photo-1548036328-c9fa89d128fa?q=80&w=800&auto=format&fit=crop', category: 'Bags' },
  { id: 5, name: 'Neck Brace Guard', brand: 'Generic', price: '₹899', rating: 4.4, reviews: 57, image: 'https://images.unsplash.com/photo-1558191053-8edcb01e1da3?q=80&w=800&auto=format&fit=crop', category: 'Protection' },
  { id: 6, name: 'Saddle Bags Pair', brand: 'BKW', price: '₹2,200', rating: 4.6, reviews: 112, image: 'https://images.unsplash.com/photo-1590432851480-163a700fb470?q=80&w=800&auto=format&fit=crop', category: 'Bags' },
  { id: 7, name: 'Short Cuff Gloves', brand: 'Rynox', price: '₹1,299', rating: 4.5, reviews: 230, image: 'https://images.unsplash.com/photo-1627616196590-f6c13def6509?q=80&w=800&auto=format&fit=crop', category: 'Gloves' },
  { id: 8, name: 'Adventure Riding Boots', brand: 'Cramster', price: '₹7,500', rating: 4.8, reviews: 34, image: 'https://images.unsplash.com/photo-1609630875171-b132137746f3?q=80&w=800&auto=format&fit=crop', badge: 'New', category: 'Boots' },
];

const CATEGORIES = ['All', 'Gloves', 'Boots', 'Bags', 'Protection'];
      ...
      <div className="bg-light-grey py-16 border-b border-gray-100">
        <div className="container mx-auto px-6 md:px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <p className="text-sm font-bold text-racing-red tracking-widest uppercase mb-2">Complete Your Ride</p>
            <h1 className="text-4xl md:text-6xl font-extrabold text-carbon-black mb-4">Accessories</h1>
            <p className="text-gray-500 text-lg max-w-xl">From gloves to boots, bags to knee guards — every rider accessory you need in one place.</p>
            <div className="flex items-center gap-2 mt-6 text-sm text-carbon-black font-semibold">
              <Zap size={16} className="text-racing-red" /> Fast Shipping Available
            </div>
          </motion.div>
        </div>
      </div>
          ...
          {filtered.map(product => (
            <motion.div key={product.id} variants={itemVariants}
              ...
              <div className="relative aspect-square overflow-hidden bg-light-grey">
                {product.badge && <div className={`absolute top-4 left-4 z-10 text-white text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wide ${product.badge === 'Bestseller' ? 'bg-amber-500' : 'bg-carbon-black'}`}>{product.badge}</div>}
